...
const navbar = (args) => {
  return `
      <nav> 
        ...
        <a href="html/Biography.html">Biography</a> 
        <a href="html/Career-Goals.html">Career-Goals</a>
        <a href="html/Activities-Organizations.html">Activities/Organizations</a>
    ...
    switch (pathname) {
      case "/": { 
        ...
        <footer>
         ...
         return rawHtmlResponse (`${headCode({
          title:"Home"
         })}
         ${navbar()}
         ${htmlContent}`)
